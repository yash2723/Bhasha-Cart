...
export default function Product() {
  ...
  const handleSingleFilterChange = (sectionId, e) => {
    const searchParams = new URLSearchParams(location.search);
  ...
  useEffect(() => {
    ...
    const data = {
      ...
      color: (colorValue == null ? ["blue", "white", "black", "purple", "red"] : colorValue),
      sizes: sizeValue || [],
      minPrice,
      maxPrice,
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div>
                <div className="pt-10 pb-5 flex justify-between items-center">
                    <h1 className="text-lg font-semibold opacity-50">Filters</h1>
                    <FilterAltIcon />
                </div>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Disclosure.Panel className="pt-6">
                          <div className="space-y-4">
                            <FormControl>
                            <RadioGroup aria-aria-labelledby="demo-radio-buttons-group-label" defaultValue="" name="radio-buttons-group">
                                {section.options.map((option, optionIdx) => (
                                    <FormControlLabel onChange={(e) => handleSingleFilterChange(section.id, e)} value={option.value} control={<Radio />} label={option.label} />
                                ))}
                            </RadioGroup>
                            </FormControl>
                          </div>
